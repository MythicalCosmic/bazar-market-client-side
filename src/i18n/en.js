export default {
  ...
  'gate.title': 'Bazar Market runs in Telegram',
  'gate.subtitle': 'This shop opens inside Telegram. Tap below to launch it in the Telegram app.',
  'gate.open_button': 'Open in Telegram',
