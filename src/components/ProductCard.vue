...
<template>
  ...
  >
    ...
    <!-- Image -->
    <div class="w-full flex items-center justify-center p-3 mb-1 rounded-xl overflow-hidden" style="height: 140px; background: var(--img-bg);">
      <img v-if="product.image" :src="product.image" :alt="getLocalizedName(product.name)" class="max-w-full max-h-full object-contain" style="mix-blend-mode: var(--img-blend);"/>
