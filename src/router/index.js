...
const routeOrder = ['splash', 'home', 'categories', 'favorites', 'cart', 'checkout', 'orders', 'profile', 'settings', 'support', 'payment-methods', 'login', 'register', 'verify', 'addresses', 'coupons', 'rewards', 'product']
