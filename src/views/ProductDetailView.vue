  ...
  <div class="min-h-screen pb-28" style="background: var(--bg-app)">
    ...
    <template v-else-if="product">
      ...
      <div class="relative" style="background: var(--surface)">
        ...
        <div class="w-full flex items-center justify-center p-6" style="height: 280px; background: var(--img-bg);">
          <img v-if="allImages.length" :src="allImages[activeImage]" :alt="getLocalizedName(product.name)" class="max-w-full max-h-full object-contain" style="mix-blend-mode: var(--img-blend);" />
